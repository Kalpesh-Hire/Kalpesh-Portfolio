      ...
      >
        <div className="container mx-auto px-8">
          ...
          <div className="flex flex-col md:flex-row space-x-2 justify-center">
            ...
            <div className="hover:shadow-lg hover:shadow-indigo-500/50 hover:translate-y-0 hover:duration-500 flex flex-col my-2 items-center justify-centerstify-ce border-[2px] rounded-xl p-6 border-gray-500">
              <h1 className="my-6 text-xl md:text-xl">
                Library and Frameworks
              </h1>
              <ul className="flex">
            ...
            {/* Technologies */}
            <div className="hover:shadow-lg hover:shadow-indigo-500/50 hover:translate-y-0 hover:duration-500 flex flex-col items-center border-[2px] rounded-xl p-6 border-gray-500">
              <h1 className="my-6 text-xl md:text-xl">Technologies</h1>
              <ul className="flex space-x-2">
                {iconsTech.map(({ icons, title, id }) => (
                  <li className="" key={id}>
                    <h1 className="text-3xl md:mx-4 md:text-4xl md:p-3 border-[2px] rounded-full mx-3 p-2 cursor-pointer hover:translate-y-2 duration-500">
                      {icons}
                    </h1>
                    <h1 className="text-sm my-3 mx-2 md:mx-6">{title}</h1>
                  </li>
